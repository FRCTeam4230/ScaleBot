...
public class Robot extends TimedRobot {
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        SmartDashboard.putNumber("Lift", RobotMap.cubeLiftSlider.getSelectedSensorPosition(0));
        
        //tuneMagic(RobotMap.driveTrainR1, 40, prefs);
    ...
    private void tuneMagic(WPI_TalonSRX motor, double maxRotation, Preferences pref) {
    	...
    	SmartDashboard.putNumber("Speed", motor.getSelectedSensorPosition(0));
