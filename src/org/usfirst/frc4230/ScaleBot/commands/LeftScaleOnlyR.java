 ...
 *
 */
public class LeftScaleOnlyR extends CommandGroup {

    public LeftScaleOnlyR() {
        // Add Commands here:
    	...
    	addSequential(new DriveFwd(4000.0, 80000.0, 0.0));
    	addSequential(new Intake(-0.5, 0.5));
    	addSequential(new Turn(70.0, 3000.0, -3000.0));
    	/*addParallel(new Lift(-0.8, 15000, true));
    	addSequential(new DriveFwd(4000, 94000.0, 80.0));
    	...
    	addSequential(new DriveFwd(-2000, 5000.0, 0.0));
